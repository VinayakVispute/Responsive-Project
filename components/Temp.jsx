...
export default function Home() {
  ...
  return (
    <>
      {/* ========== */}
      <nav className=" shadow-md w-full fixed top-0 left-0 sm:hidden">
      ...
      >
        <div className="flex">
          <aside className="h-screen flex z-10">
            <nav
          ...
          <main className="fixed ml-4 mt-16 sm:mt-4 w-full sm:static"></main>
        </div>
      </SideBarContext.Provider>
    </>
  );
...
// {
//   <main className="fixed border-8 border-red-900 ml-4 mt-24 sm:mt-4 w-full gap-2 mr-4">
//     <div className="grid grid-cols-[3fr_280px] grid-rows-1">
//       <DicussionForum />
//       <MarketStories />
//     </div>
//   </main>;
